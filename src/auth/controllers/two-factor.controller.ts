...
export class TwoFactorController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates or returns the authenticator secret and QR data for the authenticated user.',
  })
  @ApiCreatedResponse({
  ...
  @ApiCreatedResponse({
    ...
    schema: { example: { enabled: true, message: 'Two-factor authentication enabled' } },
  })
  async enable(@Req() req) {
  ...
  @ApiCreatedResponse({
    ...
    schema: { example: { enabled: false, message: 'Two-factor authentication disabled' } },
  })
